...
public class PagoControllerAdmin implements Initializable {
    @javafx.fxml.FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        tvPagos.setOnMouseClicked(event -> {
            if (event.getButton().equals(MouseButton.PRIMARY) && event.getClickCount() == 2) {
                ...
                if (selectedPagos != null) {
                    ...
                    try {
                        Main.changeScene("EPA-view.fxml","Editar Pagos");
                    } catch (IOException e) {
        ...
        lblText.setText("Dinero en Pagos - "+(valorTotal));
        lblTotal.setText("Beneficios : "+ valorCom);
    }
