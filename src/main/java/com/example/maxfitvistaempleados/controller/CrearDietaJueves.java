...
public class CrearDietaJueves implements Initializable {
    @javafx.fxml.FXML
    ...
    public void SiguienteDia(ActionEvent actionEvent) throws IOException {
        ...
        // Cambiar a la siguiente escena
        Main.changeScene("CD5-view.fxml", "Crear Dietas Viernes");
    }
    ...
    public void VolverAtras(ActionEvent actionEvent) throws IOException {
        Main.changeScene("CD3-view.fxml", "Crear Dietas Miercoles");
    }
