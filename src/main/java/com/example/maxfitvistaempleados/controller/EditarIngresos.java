...
public class EditarIngresos implements Initializable {
    ...
    public void EIngreso(ActionEvent actionEvent) throws IOException {
        ...
        ingresos.setId(Sesion.getPagos().getId());
        ...
        ingresos.setFecha(Sesion.getPagos().getFecha());
        ...
        alert.setContentText("Nombre del Ingreso: " + Sesion.getCliente().getNombre() + " realizado por " +  Sesion.getEmpleado().getNombre() + " "+ Sesion.getEmpleado().getApellidos());
        alert.showAndWait();
    }
